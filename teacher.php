        ...
        <div class="modal-content">
          ...
          <hr>
            <div id="add_class_form">
              ...
              <input class="form-control" name="code" placeholder="Code , Eg : ISE-322">
              ...
              <input class="form-control" name="start" placeholder="Starting Roll Number (Eg. 201/IS/20)">
              <input class="form-control" name="end" placeholder="Ending Roll Number (Eg. 265/IS/20)">
